...
public class menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLideres.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/imagenes/BTN_90.png"))); // NOI18N
        btnLideres.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnLideresMouseClicked(evt);
            }
        });
    ...
    private void btnLideresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLideresActionPerformed
        ReportesLideres re = new ReportesLideres();
        re.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnLideresActionPerformed

    private void btnLideresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLideresMouseClicked
        
    }//GEN-LAST:event_btnLideresMouseClicked
